...
이 디렉토리는 실제 작업 시나리오를 예시로 보여주는 문서 모음이다.

목적은 문서 구조 자체를 설명하는 것이 아니라,
사람이 요청하고 AI 에이전트가 현재 프로젝트 규칙에 맞춰 어떻게 대응하는지 구체적인 흐름을 보여주는 데 있다.
...
이 디렉토리의 문서는 사람 관점에서 읽는 시나리오 예시이며,
실제 템플릿 원본은 `ai/templates/`에 있다.
